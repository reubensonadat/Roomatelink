...
export function DashboardNav() {
  ...
  const activeIndex = NAV_ITEMS.findIndex(item => item.url === pathname);

  return (
    <nav className="fixed bottom-4 sm:bottom-6 left-4 right-4 z-50 bg-background/95 backdrop-blur-xl border border-border/50 max-w-[480px] mx-auto rounded-[24px] shadow-[0_20px_40px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.4)] md:bottom-8">
