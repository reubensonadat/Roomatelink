...
export default function AuthPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // If no error, the browser will redirect to Google's login page automatically
  };
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-background overflow-hidden selection:bg-primary/20">
      ...
      <div className="w-full max-w-[440px] px-6 z-10 py-12">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-center pr-1">
                  ...
                  {mode === 'signin' && (
                    <Link href="#" className="text-[12px] text-muted-foreground hover:text-primary font-medium transition-colors">Forgot?</Link>
                  )}
                </div>
                <div className="relative">
                    ...
                    <div className="bg-primary/5 border border-primary/20 rounded-2xl p-3.5 flex gap-3 shadow-inner">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[12px] text-muted-foreground leading-relaxed">
                          It is <strong className="text-foreground">highly advised</strong> to sign up with your valid email address to receive the <strong className="text-foreground">Verified</strong> badge automatically.
                        </span>
                      </div>
                    </div>
                  </motion.div>
        ...
        >
          By {mode === 'signin' ? 'signing in' : 'signing up'}, you agree to our <br className="sm:hidden" /> <Link href="/terms" className="text-foreground hover:underline transition-colors font-medium">Terms & Conditions</Link> and <Link href="/privacy" className="text-foreground hover:underline transition-colors font-medium">Privacy Policy</Link>.
        </motion.p>
      </div>
    </div>
  );
