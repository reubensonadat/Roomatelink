...
import { ArrowRight, ShieldCheck, Ghost, UserCheck, VolumeX, MessageCircleOff, Coffee, Instagram, Twitter, Linkedin, Menu, X, CheckCircle2, Tag } from 'lucide-react';
      ...
      <header className="fixed top-0 left-0 w-full bg-background/80 backdrop-blur-xl z-50 border-b border-border transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 h-[72px] flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/auth" className="px-5 py-2.5 rounded-2xl bg-primary text-primary-foreground font-medium text-[14px] hover:bg-primary/90 transition-colors shadow-sm">
              Get Started
            </Link>
          </div>
          ...
          {isMenuOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed top-0 right-0 w-[66%] h-screen bg-card/95 backdrop-blur-xl z-50 border-l border-border shadow-2xl flex flex-col pt-32 px-6 gap-4 md:hidden"
              >
                ...
                <div className="mt-auto pb-10">
                  <Link href="/auth" onClick={() => setIsMenuOpen(false)} className="flex items-center justify-center py-4 rounded-2xl bg-primary text-primary-foreground font-bold text-[15px] w-full shadow-lg active:scale-95 transition-transform">
                    Get Started
                  </Link>
                </div>
              </motion.div>
      ...
      <main className="pt-[72px] overflow-x-hidden">
        ...
        >
          ...
          <motion.h1 variants={fadeUp} className="text-5xl sm:text-[6rem] leading-[1.05] font-extrabold tracking-tight mb-8 text-foreground transition-colors duration-300">
            Don't Gamble on <br className="hidden sm:block" /> Your <span className="text-primary">Roommate.</span>
          </motion.h1>
          ...
          <motion.div variants={fadeUp}>
            <Link href="/auth" className="w-full sm:w-auto px-10 py-4 rounded-2xl bg-foreground text-background font-medium text-[16px] transition-transform hover:scale-[1.02] active:scale-95 shadow-md flex justify-center items-center gap-2">
        ...
        >
          <div className="flex flex-col md:flex-row gap-24 items-center">
            ...
            <div className="w-full md:w-[55%] order-1 md:order-2">
              <motion.h2 variants={fadeUp} className="text-3xl sm:text-[2.5rem] font-bold tracking-tight mb-8 text-foreground leading-[1.1]">How it feels mathematically.</motion.h2>
              ...
              <div className="relative border-l border-border ml-4 space-y-14">
                <motion.div variants={fadeUp} className="relative pl-12 flex flex-col">
                  ...
                  <h3 className="font-bold text-xl text-foreground mb-2">Take Vibe Check</h3>
                  <p className="font-medium text-muted-foreground text-[15px] leading-relaxed">A highly curated lifestyle questionnaire mapping out how you genuinely prefer to live.</p>
                </motion.div>
                <motion.div variants={fadeUp} className="relative pl-12 flex flex-col">
                  ...
                  <h3 className="font-bold text-xl text-foreground mb-2">Review The Math</h3>
                  <p className="font-medium text-muted-foreground text-[15px] leading-relaxed">Securely browse students who share your exact living habits natively mapped out for you.</p>
                </motion.div>
                <motion.div variants={fadeUp} className="relative pl-12 flex flex-col">
                  ...
                  <h3 className="font-bold text-xl text-foreground mb-2">Connect Safely</h3>
                  <p className="font-medium text-muted-foreground text-[15px] leading-relaxed">Unlock your customized matches and start chatting securely before making any commitments.</p>
                </motion.div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <motion.div variants={fadeUp} className="text-center mb-16 max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground text-[17px] font-medium leading-relaxed">To keep the platform organically free of bots, ghosts, and intrusive ads, we charge a microscopic verification fee. No subscriptions. No hidden costs.</p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-card rounded-[2.5rem] shadow-xl border border-border p-8 sm:p-12 flex flex-col order-1 lg:order-2">
                ...
                <p className="text-muted-foreground font-medium text-[15px] mb-8 pb-8 border-b border-border">It gives you access to the system and you will find your roommates within 60 days.</p>
                ...
                <Link href="/auth" className="w-full py-4 rounded-2xl bg-foreground text-background font-bold text-[16px] transition-transform hover:scale-[1.02] active:scale-95 shadow-md flex justify-center items-center">
                  Get Started
                </Link>
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10 max-w-4xl mx-auto text-left">
            ...
            <motion.div variants={fadeUp}>
              ...
              <p className="text-muted-foreground font-medium text-[15px] leading-relaxed">We verify users who sign up with valid student email addresses. While anyone can join, having a verified badge builds massive trust in the ecosystem.</p>
            </motion.div>
            <motion.div variants={fadeUp}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-20">
            <div className="col-span-1 sm:col-span-2">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-10 h-10 flex items-center justify-center bg-muted rounded-2xl hover:bg-foreground hover:text-background transition-colors text-foreground"><Instagram className="w-4 h-4" /></a>
                <a href="#" className="w-10 h-10 flex items-center justify-center bg-muted rounded-2xl hover:bg-foreground hover:text-background transition-colors text-foreground"><Twitter className="w-4 h-4" /></a>
                <a href="#" className="w-10 h-10 flex items-center justify-center bg-muted rounded-2xl hover:bg-foreground hover:text-background transition-colors text-foreground"><Linkedin className="w-4 h-4" /></a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-[14px] font-medium">
                ...
                <li><Link href="/auth" className="text-muted-foreground hover:text-foreground transition-colors">Get Started</Link></li>
              </ul>
            </div>
