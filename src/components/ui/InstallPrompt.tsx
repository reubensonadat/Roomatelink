    ...
    <AnimatePresence>
      {showPrompt && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-primary text-primary-foreground p-4 rounded-2xl shadow-xl z-50 flex items-center gap-4"
        >
